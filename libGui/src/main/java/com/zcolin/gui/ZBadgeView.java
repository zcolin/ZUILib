 ...
 * @author Jeff Gilfelt
 */
public class ZBadgeView extends TextView {
     ...
     */
    public ZBadgeView(Context context, View target) {
     ...
     */
    public ZBadgeView(Context context, TabWidget target, int index) {
        this(context, null, android.R.attr.textViewStyle, target, index);
    }

    public ZBadgeView(Context context, AttributeSet attrs, int defStyle) {
        this(context, attrs, defStyle, null, 0);
    }

    public ZBadgeView(Context context, AttributeSet attrs, int defStyle, View target, int tabIndex) {
