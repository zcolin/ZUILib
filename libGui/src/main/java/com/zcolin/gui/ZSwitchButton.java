 ...
 *
 * @author TYR
 * @since 2021/9/15 11:19
 */
public final class ZSwitchButton extends View {
    ...
    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    public ZSwitchButton(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    public ZSwitchButton(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, defStyleAttr, 0);
    }

    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    public ZSwitchButton(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        super(context, attrs, defStyleAttr, defStyleRes);

        setLayerType(LAYER_TYPE_SOFTWARE, null);

        TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.ZSwitchButton);
        mChecked = array.getBoolean(R.styleable.ZSwitchButton_android_checked, mChecked);
        setEnabled(array.getBoolean(R.styleable.ZSwitchButton_android_enabled, isEnabled()));
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        switch (MeasureSpec.getMode(widthMeasureSpec)) {
            ...
            case MeasureSpec.UNSPECIFIED:
                widthMeasureSpec =
                        MeasureSpec.makeMeasureSpec((int) (TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP,
                                                                                                56,
                                                                                                getResources().getDisplayMetrics()) + getPaddingLeft() + getPaddingRight()),
                                                               MeasureSpec.EXACTLY);
                break;
        ...
        switch (MeasureSpec.getMode(heightMeasureSpec)) {
            ...
            case MeasureSpec.UNSPECIFIED:
                heightMeasureSpec =
                        MeasureSpec.makeMeasureSpec((int) (MeasureSpec.getSize(widthMeasureSpec) * mAspectRatio) + getPaddingTop() + getPaddingBottom(),
                                                                MeasureSpec.EXACTLY);
                break;
            case MeasureSpec.EXACTLY:
            default:
    ...
    protected void onSizeChanged(int width, int height, int oldWidth, int oldHeight) {
        isCanVisibleDrawing =
                width > getPaddingLeft() + getPaddingRight() && height > getPaddingTop() + getPaddingBottom();
        ...
        if (isCanVisibleDrawing) {
            ...
            mShadowGradient = new RadialGradient(bCenterX,
                                                 bCenterY,
                                                 mRadius,
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        if (isEnabled() && (mCheckedState == STATE_SWITCH_ON || mCheckedState == STATE_SWITCH_OFF) && (mAnim1 * mAnim2 == 0)) {
    ...
    public interface OnCheckedChangeListener {
         ...
         * @param checked 是否选中
         */
        void onCheckedChanged(ZSwitchButton button, boolean checked);
    }
