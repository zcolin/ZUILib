...
public abstract class AbstractWheelTextAdapter extends AbstractWheelAdapter {
    ...
    private static int             maxcolor     = Color.BLACK;
    private static int             mincolor     = Color.BLACK;
    ...
    protected AbstractWheelTextAdapter(Context context, int itemResource) {
        this(context, itemResource, NO_RESOURCE, 0, maxsize, minsize, maxcolor, mincolor);
    }
    ...
    protected AbstractWheelTextAdapter(Context context, int itemResource, int itemTextResource, int currentIndex,
        ...
        AbstractWheelTextAdapter.maxcolor = maxcolor;
        AbstractWheelTextAdapter.mincolor = mincolor;
        ...
        if (index >= 0 && index < getItemsCount()) {
            ...
            if (textView != null) {
                ...
                if (index == currentIndex) {
                    ...
                    textView.setTextColor(maxcolor);
                } else {
                    textView.setTextSize(minsize);
                    textView.setTextColor(mincolor);
                }
