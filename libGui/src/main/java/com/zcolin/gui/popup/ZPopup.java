 ...
 */
public class ZPopup extends ZBasePopup {
    ...
    public ZPopup(Context context) {
        this(context, DIRECTION_NONE);
    }

    public ZPopup(Context context, @Direction int preferredDirection) {
        super(context);
    ...
    private void setAnimationStyle(int screenWidth, int requestedX) {
        ...
        switch (mAnimStyle) {
            case ANIM_GROW_FROM_LEFT:
                mWindow.setAnimationStyle(onTop ? R.style.pop_up_menu_left : R.style.pop_down_menu_left);
                break;
            case ANIM_GROW_FROM_RIGHT:
                mWindow.setAnimationStyle(onTop ? R.style.pop_up_menu_right : R.style.pop_down_menu_right);
                break;
            case ANIM_GROW_FROM_CENTER:
                mWindow.setAnimationStyle(onTop ? R.style.pop_up_menu_center : R.style.pop_down_menu_center);
                break;
            case ANIM_AUTO:
    ...
    public void setContentView(View root) {
        ...
        FrameLayout layout = (FrameLayout) LayoutInflater.from(mContext).inflate(getRootLayout(), null, false);
    ...
    protected int getRootLayout() {
        return R.layout.gui_popup_layout;
    }

    protected int getRootLayoutRadius(Context context) {
        return ZUIHelper.dip2px(context, 5);
    }
